...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:black;">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'"> AB Fashion Hub</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#headphones" class="dropdown-item">Headphones/Gadgets</a>
                               </div>
